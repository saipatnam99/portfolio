...
const Contact = () => {
  return (
    <section id="contact" className="bg-gray-700 px-2 py-3 text-center text-white sm:px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 text-sm sm:text-base lg:flex-nowrap">
          <div className="inline-flex items-center justify-center gap-2 rounded-full bg-white/5 px-1 py-2">
